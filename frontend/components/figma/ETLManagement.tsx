    ...
    <div className="p-6">
      <div className="mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-gray-900 mb-2">Data Flow Management</h1>
            <p className="text-gray-600">Monitor and control your Data Flow pipelines</p>
          </div>
          ...
          {[
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg transition-colors ${
                selectedStatus === tab.key ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
      ...
      <div className="space-y-4">
        {filteredPipelines.map((pipeline) => (
          <div key={pipeline.id} className="bg-white p-5 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5 pt-4 border-t border-gray-200">
              <div>
            ...
            {pipeline.status === 'failed' && (
              <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <div className="text-red-900 text-sm">Data Flow Failed</div>
                    <div className="text-red-700 text-sm mt-1">
                      Error: Connection timeout to destination. Last successful run processed 23,456 records.
                    </div>
                  </div>
                </div>
              </div>
      ...
      {filteredPipelines.length === 0 && (
        <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
          ...
          <h3 className="text-gray-900 mb-2">No data flows found</h3>
          <p className="text-gray-600">No data flows match the selected status</p>
        </div>
      )}
    </div>
  );
